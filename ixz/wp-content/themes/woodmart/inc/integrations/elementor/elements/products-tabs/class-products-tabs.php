	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tabs-design-simple .products-tabs-title li.wd-active a, {{WRAPPER}} .tabs-design-simple .products-tabs-title li:hover a, {{WRAPPER}} .tabs-design-simple .owl-nav > div:hover, {{WRAPPER}} .tabs-design-simple .wrap-loading-arrow > div:not(.disabled):hover' => 'color: {{VALUE}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'return_value' => '1',
				'condition'    => array(
					'product_hover' => array( 'icons', 'alt', 'button', 'standard', 'tiled', 'quick', 'base' ),
				),
			]
		);
