...
<section class="section">
    <h1 class="section-title">
        <strong><?php esc_html_e('Step', 'chaty');?> 3:</strong> <?php esc_html_e('Triggers and targeting', 'chaty');?>
    </h1>

    <div class="form-horizontal">
        <div class="form-horizontal__item flex-center single-channel-setting active">
            <label class="form-horizontal__item-label" for="chaty_icons_view"><?php esc_html_e('Icons view', 'chaty');?>:</label>
            <div>
                <?php
                $modes = [
        ...
        <div class="form-horizontal__item flex-center single-channel-setting active">
            <label class="form-horizontal__item-label"><?php esc_html_e('Default state', 'chaty');?>:</label>
            <div>
                <?php
                $states = [
                    "click" => "Click to open",
            ...
            <div class="chaty-option-box">
                <div id="date-schedule" class="<?php echo ($status == "yes") ? "active" : "" ?>">
                    <div class="date-schedule-box">
                        <div class="date-schedule">
                            <div class="date-schedule-items">
                                <div class="select-box">
                                    <label><?php esc_html_e('Timezone', 'chaty');?></label>
                                ...
                                <div class="date-time-box">
                                    <div class="date-select-option">
                                        <label for="date_start_date">
                                            ...
                                            <?php esc_html_e('Start Date', 'chaty');?></label>
                                        <input type="text" name="cht_date_rules[start_date]" id="date_start_date" value="<?php echo esc_attr($startDate) ?>" >
                                    </div>
                                    <div class="time-select-option">
                                        <label for="date_start_time"><?php esc_html_e('Start Time', 'chaty');?></label>
                                ...
                                <div class="date-select-option">
                                    ...
                                    <?php esc_html_e('End Date', 'chaty');?></label>
                                    <input type="text" name="cht_date_rules[end_date]" id="date_end_date" value="<?php echo esc_attr($endDate) ?>">
                                </div>
                                <div class="time-select-option">
                                    <label for="date_end_time"><?php esc_html_e('End Time', 'chaty');?></label>
                        ...
                        <a href="javascript:;" class="create-rule remove-rules" id="remove-date-rule"><?php esc_html_e('Remove Rules', 'chaty');?></a>
                    </div>
                    <div class="date-schedule-button">
                        <a href="javascript:;" class="create-rule" id="create-date-rule"><?php esc_html_e('Add Rule', 'chaty');?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="form-horizontal__item flex-center">
            <label class="form-horizontal__item-label">
                ...
                <?php esc_html_e('Days and hours', 'chaty');?>:</label>
            <div class="chaty-option-box">
