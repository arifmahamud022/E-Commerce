...
function check_for_preview_pos() {
    ...
    if (jQuery("#scroll-to-item").length && jQuery("#admin-preview").length && jQuery("#chaty-tab-triger-targeting").hasClass("active")) {
        if(jQuery("body").hasClass("has-premio-box")) {
            topPos = jQuery("#scroll-to-item").offset().top + jQuery("#scroll-to-item").height() - jQuery(window).scrollTop() - 645;
        } else {
            topPos = jQuery("#scroll-to-item").offset().top + jQuery("#scroll-to-item").height() - jQuery(window).scrollTop() - 505;
        }
        ...
        if(jQuery(".footer-buttons").length) {
            if(jQuery("body").hasClass("has-premio-box")) {
                topPos = jQuery(".footer-buttons").offset().top - jQuery(window).scrollTop() - 695;
            } else {
                topPos = jQuery(".footer-buttons").offset().top - jQuery(window).scrollTop() - 565;
            }
        }
        if (topPos < 0) {
            topPos = Math.abs(topPos);
    ...
    if(jQuery(window).height() <= 1180) {
        ...
        if(jQuery("a.remove-chaty-widget-sticky").length) {
            totalHeight += 102;
        }
    ...
    if(jQuery("#chaty-container").length) {
        if(jQuery("#chaty-container").offset().top - jQuery(window).scrollTop() >= jQuery("#wpadminbar").height()) {
            jQuery("#admin-preview").addClass("remove-sticky");
        } else {
            jQuery("#admin-preview").removeClass("remove-sticky");
        }
    }
}
...
(function (factory) {
    ...
    $(document).ready(function(){
        ...
        $(document).on("click", "#chaty-social-channel", function(){
            ...
            if($("#chaty-tab-social-channel").length) {
                $("body,html").animate({
                    scrollTop: $("#chaty-header").offset().top
                }, 500);
            }
            $("#admin-preview").prop("style","");
            $("#current_step").val(1);
        });
        ...
        $(document).on("click", "#chaty-triger-targeting", function(){
            ...
            if($("#chaty-tab-triger-targeting").length) {
                $("body,html").animate({
                    scrollTop: $("#chaty-header").offset().top
                }, 500);
            }
        ...
        $(document).on("click", "#back-button", function(e){
            ...
            if($("#chaty-tab-triger-targeting").hasClass("active")) {
                ...
                if($("#chaty-tab-customize-widget").length) {
                    $("body,html").animate({
                        scrollTop: $("#chaty-header").offset().top
                    }, 500);
                }
    ...
    function checkForPosition() {
        if($("#chaty-header").length) {
            if($("#chaty-header").offset().top  - $(window).scrollTop() < 0) {
                $(".chaty-header").css("margin-left", $("#chaty-header").offset().left);
                $(".chaty-header").addClass("sticky-pos");
                $(".chaty-header-sticky").addClass("active");
            } else {
                $(".chaty-header-sticky").removeClass("active");
                $(".chaty-header").removeClass("sticky-pos");
                $(".chaty-header").prop("style","");
            }
        }
    }
}));