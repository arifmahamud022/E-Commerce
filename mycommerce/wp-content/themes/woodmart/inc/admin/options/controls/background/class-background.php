		...
		?>
			<div class="xts-bg-source">
				...
				<div class="xts-upload-btns">
					...
					<button class="xts-btn xts-color-warning xts-remove-upload-btn<?php echo ( isset( $value['url'] ) && ! empty( $value['url'] ) ) ? ' xts-active' : ''; ?>"><?php esc_html_e( 'Remove', 'woodmart' ); ?></button>
